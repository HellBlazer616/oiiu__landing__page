...
$(function() {
  ...
  // --------------------------------------------- //
  $(function () {
    $('#countdown').countdown({until: $.countdown.UTCDate(+10, 2020, 08, 15), format: 'D'});
  });
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
  ...
  $('.notify-form').ajaxChimp({
    ...
    url: 'https://oiiu.us10.list-manage.com/subscribe/post?u=263346e55226f6a723c76a733&amp;id=63f4b2d442"'
  });
